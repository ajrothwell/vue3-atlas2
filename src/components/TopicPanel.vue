  ...
  <section>
    ...
    <div v-if="address">
      ...
      <div class="topics pr-4">      
        ...
        <topic v-show="CondosStore.condosData.features.length" :topic-name="'Condominiums'" :topic-icon="'fa-solid fa-building'" :loading="!dataSourcesLoadedArray.includes('Condominiums')">
